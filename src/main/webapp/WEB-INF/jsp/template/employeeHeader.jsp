...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 10px;">
  <a class="navbar-brand" href="user/newRegulations">Employee Management System</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="user/newRegulations">New Regulations<span class="sr-only">(current)</span></a>
      </li>
      
      <li class="nav-item active">
        <a class="nav-link" href="user/oldRegulations">Commented Regulations<span class="sr-only">(current)</span></a>
      </li>
    </ul>
